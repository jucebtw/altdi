# Обновление MasterDashboard.jsx на сервере

Выполните эту команду на сервере, чтобы обновить файл и убрать проверку роли:

```bash
cd /var/www/vitrina/frontend

# Обновить MasterDashboard.jsx
cat > src/pages/MasterDashboard.jsx << 'EOF'
